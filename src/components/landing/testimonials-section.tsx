...
const testimonials = [
  {
    ...
    content:
      "Scanorderly đã giúp chúng tôi quản lý hệ thống đặt món một cách hiệu quả. Dashboard rất trực quan và dễ sử dụng.",
    rating: 5,
    avatar: "NA",
  },
  {
    ...
    content:
      "Tính năng theo dõi doanh thu real-time rất hữu ích. Chúng tôi có thể đưa ra quyết định kinh doanh nhanh chóng.",
    rating: 5,
    avatar: "TB",
  },
  {
    ...
    content:
      "Hệ thống thanh toán tích hợp rất an toàn và thuận tiện. Khách hàng rất hài lòng với trải nghiệm đặt món.",
    rating: 5,
    avatar: "LC",
  },
  {
    ...
    content:
      "Support team rất nhiệt tình và chuyên nghiệp. Mọi vấn đề đều được giải quyết nhanh chóng.",
    rating: 5,
    avatar: "PD",
  },
  {
    ...
    content:
      "Tính năng quản lý reviews giúp chúng tôi nắm bắt được feedback khách hàng và cải thiện dịch vụ liên tục.",
    rating: 5,
    avatar: "HE",
  },
  {
    ...
    content:
      "Giá cả hợp lý, tính năng đầy đủ. Đây là giải pháp tốt nhất cho các startup F&B như chúng tôi.",
    rating: 5,
    avatar: "DF",
  },
];
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-16 max-w-2xl text-lg text-muted-foreground">
            ...
            nghiệm khách hàng đáng kể khi sử dụng Scanorderly.
          </p>
        </div>
