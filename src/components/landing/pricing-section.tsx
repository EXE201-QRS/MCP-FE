...
const plans = [
  {
    ...
    limitations: ["Không có analytics nâng cao", "Không custom branding"],
  },
  {
    name: "Professional",
    price: "399,000",
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl text-center">
          ...
          <p className="mx-auto mb-16 max-w-2xl text-lg text-muted-foreground">
            Bắt đầu miễn phí 14 ngày. Không cần thẻ tín dụng. Hủy bất cứ lúc
            nào.
          </p>
        </div>
              ...
              <CardContent className="space-y-6">
                <div className="flex flex-col gap-2">
                  ...
                  <Button className="w-full" variant="ghost" size="sm" asChild>
                    <Link href="/plans">Xem tất cả gói</Link>
                  </Button>
                </div>
          ...
          <div className="grid gap-6 md:grid-cols-2">
            <div className="text-left">
              <h4 className="mb-2 font-medium">
                Có thể hủy gói dịch vụ bất cứ lúc nào?
              </h4>
            ...
            <div className="text-left">
              <h4 className="mb-2 font-medium">
                Có hỗ trợ migrate dữ liệu không?
              </h4>
              <p className="text-sm text-muted-foreground">
                Có, chúng tôi hỗ trợ migrate dữ liệu miễn phí cho tất cả gói
                dịch vụ.
              </p>
            </div>
            <div className="text-left">
              <h4 className="mb-2 font-medium">
                Có thể nâng cấp/hạ cấp gói không?
              </h4>
              <p className="text-sm text-muted-foreground">
            ...
            <div className="text-left">
              ...
              <p className="text-sm text-muted-foreground">
                Chúng tôi hỗ trợ thẻ tín dụng, chuyển khoản ngân hàng và ví điện
                tử.
              </p>
            </div>
          </div>
