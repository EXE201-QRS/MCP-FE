...
import { IconEye, IconEyeOff, IconLoader2, IconMail, IconShield, IconCheck } from "@tabler/icons-react"
...
export function ForgotPasswordForm() {
  ...
  const onSubmit = async (data: ForgotPasswordBodyType) => {
    ...
    if (!data.newPassword) {
      form.setError("newPassword", { type: "manual", message: "Mật khẩu mới là bắt buộc" })
      return
    }
    if (data.newPassword !== data.confirmNewPassword) {
      form.setError("confirmNewPassword", { type: "manual", message: "Mật khẩu xác nhận không khớp" })
      return
    }
      ...
      <div className="space-y-2">
        ...
        <div className="flex gap-2">
          ...
          <Button
            ...
            disabled={sendOTPMutation.isPending || countdown > 0 || !watchedEmail}
            className="shrink-0"
          >
